...
export const metadata: Metadata = {
  ...
  description:
    "Tide Life shipping policy — same-day dispatch before 2pm EST, tracked US delivery in 3–5 business days, free shipping over $200. Returns and handling information.",
  alternates: { canonical: `${SITE}/shipping` },
  openGraph: {
    title: "Shipping & Returns | Tide Life",
